// https://atcoder.jp/contests/tessoku-book/submissions/38861326
#include <iostream>
#include <queue>
#include <map>
#include <utility>
...
namespace {
    ...
    constexpr Num base = 1000000000LL;
...
void solve(std::istream& is, std::ostream& os) {
    ...
    const auto min_value = distances.at(n);
    const auto distance = (min_value + base - 1) / base;
    const auto n_trees = base - min_value % base;
