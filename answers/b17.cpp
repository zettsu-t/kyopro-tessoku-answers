// https://atcoder.jp/contests/tessoku-book/submissions/38768744
#include <algorithm>
#include <iostream>
#include <vector>
...
void solve(std::istream& is, std::ostream& os) {
    ...
    for (decltype(n) i{2}; i<n; ++i) {
        auto cost_one = costs.at(i-1) + std::abs(heights.at(i) - heights.at(i-1));
        auto cost_two = costs.at(i-2) + std::abs(heights.at(i) - heights.at(i-2));
